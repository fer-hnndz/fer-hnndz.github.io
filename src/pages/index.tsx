...
export default function Index() {
  ...
  useEffect(() => {
    async function fetchRepos() {
      const response = await fetch(
        "https://api.github.com/users/fer-hnndz/repos?sort=pushed"
      );
      ...
      const filteredData = data.filter(
        (repo: Repository) =>
          repo.description && repo.name !== "fer-hnndz.github.io"
      );
  ...
  return (
    <div className="overflow-x-hidden scroll-smooth">
      {/* Hero Section */}
      <div
        className="bg-neutral-600 bg-[url(/src/pages/static/hero.png)] bg-blend-overlay bg-center bg-cover lg:bg-blend-normal lg:bg-none lg:bg-fellaRed 
      h-screen w-screen 
      flex flex-col-reverse md:flex-row relative text-start select-none"
      >
        {/* Left Content */}
        <div className="basis-2/3 h-full flex flex-col justify-center md:mr-8">
          <div>
            <div className="mt-8 ml-6 text-white">
              ...
              <p className="text-lg my-1 font-mono mt-5 ml-2">
                User-Agent: Jorge Hernández
              </p>
      ...
      <div className="bg-white text-black">
        ...
        <p className="text-justify text-lg font-semibold w-5/6 md:w-1/2 mx-auto mb-12">
          My name is Jorge, and I am an aspiring Software Engineer based in
          Honduras. I am currently pursuing a Bachelor's Degree in Software
          Engineering at{" "}
          <a
            className="text-blue-500"
            href="https://www.unitec.edu"
            target="_blank"
            rel="noopener noreferrer"
          >
            UNITEC
          </a>
          . Although I lack professional work experience, my eagerness to learn
          and passion for this field have driven me to work on several
          self-initiated projects. Additionally, I have contributed to improving
          existing software, such as{" "}
          <i>
            <a className="text-blue-500" href="https://casadavid.org">
              Casa David
            </a>
            's
          </i>{" "}
          internal software.
          <br />
          <br />I have been developing software independently using various
          technologies, including Python with frameworks like{" "}
          <span className="font-mono font-thin">Flask</span>, aswell as
          JavaScript with <span className="font-mono font-thin">React,</span>{" "}
          <span className="font-mono font-thin">Next.js</span> and{" "}
          <span className="font-mono font-thin">Express.js</span>.
          <br />I am committed to continuously learning and improving my skills,
          and I am always seeking new opportunities to work on projects that
          will help me grow as a software engineer.
        </p>
      </div>
      ...
      <div className="bg-black text-white">
        ...
        <p className="text-lg text-center font-semibold">
          A collection of the projects under my Github profile that I have been
          working on recently.
        </p>
          ...
          {repos.map((repo) => (
            <Card key={repo.id} title={repo.name}>
              ...
              <a href={repo.html_url}>
                <button className="text-black bg-racingYellow p-2 mt-4 rounded-md font-semibold ease-in-out duration-150 hover:-translate-y-2">
                  Visit Github
                </button>
              </a>
            </Card>
